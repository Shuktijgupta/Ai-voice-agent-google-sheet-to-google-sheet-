            ...
            <div className="w-full max-w-md glass-card rounded-3xl p-8 shadow-2xl animate-in fade-in zoom-in-95 duration-500">
                <div className="text-center mb-8">
                    ...
                    <p className="text-muted-foreground flex items-center justify-center gap-2">
                        Sign in to access your AI Recruiter <Sparkles className="w-4 h-4 text-amber-400" />
                    </p>
                </div>
                ...
                <div className="mt-8 text-center text-sm text-muted-foreground">
                    ...
                    <Link href="/signup" className="text-primary hover:text-primary/80 font-bold hover:underline transition-colors">
                        Create one now
                    </Link>
                </div>
            </div>
